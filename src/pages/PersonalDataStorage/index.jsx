            ...
            <div className='features-split-inner section-inner'>
              <div className='split-wrap'>
                <SplitItem
                  ...
                  description='Hive Elastos’ semi-decentralized storage solution. In this Hive architecture, no blockchain is used. Instead, data is stored on traditional “servers” (called “Hive nodes”) and accessed using traditional “API calls”. Though, the key feature of hive is that the servers are not provided by the application developers. They are provided as independent services by third parties or by end users themselves. Also, user data can be transferred at any moment to another location.'
                  onClick={() =>
                    (window.location.href = 'https://elastos.academy/hive/')
                  }
